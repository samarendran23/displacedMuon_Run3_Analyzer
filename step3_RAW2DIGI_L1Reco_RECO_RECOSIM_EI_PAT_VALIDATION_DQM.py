...
# with command line options: step3 -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidationNoHLT+@miniAODValidation,DQM:@standardDQMFakeHLT+@miniAODDQM --conditions auto:run2_mc -n 10 --datatier GEN-SIM-RECO,MINIAODSIM --eventcontent RECOSIM,MINIAODSIM --era Run2_2016
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RECOSIM.root'),
